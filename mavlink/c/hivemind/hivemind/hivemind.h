...
#define MAVLINK_HIVEMIND_XML_HASH 2114188862703987639
...
/** @brief AI 模块运行状态 */
#ifndef HAVE_ENUM_AI_STATUS_FLAG
#define HAVE_ENUM_AI_STATUS_FLAG
typedef enum AI_STATUS_FLAG
{
   AI_STATUS_NORMAL=0, /* 正常 | */
   AI_STATUS_FAULT=1, /* 故障 | */
   AI_STATUS_FLAG_ENUM_END=2, /*  | */
} AI_STATUS_FLAG;
#endif

/** @brief 电机运行状态 */
#ifndef HAVE_ENUM_MOTOR_STATUS_FLAG
#define HAVE_ENUM_MOTOR_STATUS_FLAG
typedef enum MOTOR_STATUS_FLAG
{
   MOTOR_STATUS_NORMAL=0, /* 正常 | */
   MOTOR_STATUS_FAULT=1, /* 故障 | */
   MOTOR_STATUS_FLAG_ENUM_END=2, /*  | */
} MOTOR_STATUS_FLAG;
#endif
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_hk_ai_status.h"
#include "./mavlink_msg_hk_motor_status.h"
