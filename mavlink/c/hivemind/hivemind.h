...
#define MAVLINK_HIVEMIND_XML_HASH -5209056325927341448
...
{
   HK_TASK_STATE_WAIT_ATTACK=0, /* WAIT_ATTACK | */
   HK_TASK_STATE_FLY_TO_TARGET=1, /* FLY_TO_TARGET | */
   HK_TASK_STATE_ADJUST_PATH=2, /* ADJUST_PATH | */
   HK_TASK_STATE_ADJUST_ANGLE=3, /* ADJUST_ANGLE | */
   HK_TASK_STATE_CIRCLE_SEARCH=4, /* CIRCLE_SEARCH | */
   HK_TASK_STATE_TURN_BACK=5, /* TURN_BACK | */
   HK_TASK_STATE_WAIT_AUTHORITY=6, /* WAIT_AUTHORITY | */
