/** @file
 *  @brief MAVLink comm protocol generated from hivemind.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_HIVEMIND_H
#define MAVLINK_HIVEMIND_H
...
#define MAVLINK_HIVEMIND_XML_HASH -1282085762224484435
...
/** @brief GPS 定位类型 */
#ifndef HAVE_ENUM_HK_GPS_FIX_TYPE
#define HAVE_ENUM_HK_GPS_FIX_TYPE
typedef enum HK_GPS_FIX_TYPE
{
   HK_GPS_FIX_TYPE_NONE=0, /* 无 | */
   HK_GPS_FIX_TYPE_NONE2=1, /* 无 | */
   HK_GPS_FIX_TYPE_2D=2, /* 2D | */
   HK_GPS_FIX_TYPE_3D=3, /* 3D | */
   HK_GPS_FIX_TYPE_RTK_FIXED=4, /* RTK 固定 | */
   HK_GPS_FIX_TYPE_RTK_FLOAT=5, /* RTK 浮点 | */
   HK_GPS_FIX_TYPE_ESTIMATED=6, /* 估计 | */
   HK_GPS_FIX_TYPE_ENUM_END=7, /*  | */
} HK_GPS_FIX_TYPE;
#endif

/** @brief 起落状态 */
#ifndef HAVE_ENUM_HK_LAND_STATE
#define HAVE_ENUM_HK_LAND_STATE
typedef enum HK_LAND_STATE
{
   HK_LAND_STATE_UNKNOWN=0, /* UNKNOWN | */
   HK_LAND_STATE_ON_GROUND=1, /* ON_GROUND | */
   HK_LAND_STATE_IN_AIR=2, /* IN_AIR | */
   HK_LAND_STATE_ENUM_END=3, /*  | */
} HK_LAND_STATE;
#endif

/** @brief 任务状态 */
#ifndef HAVE_ENUM_HK_TASK_STATE
#define HAVE_ENUM_HK_TASK_STATE
typedef enum HK_TASK_STATE
{
   HK_TASK_STATE_WAIT_ATTACK=0, /* 等待打击 | */
   HK_TASK_STATE_FLY_TO_TARGET=1, /* 飞向目标 | */
   HK_TASK_STATE_ADJUST_PATH=2, /* 调整航路 | */
   HK_TASK_STATE_ADJUST_ANGLE=3, /* 调整角度 | */
   HK_TASK_STATE_CIRCLE_SEARCH=4, /* 盘旋搜索 | */
   HK_TASK_STATE_TURN_BACK=5, /* 返航 | */
   HK_TASK_STATE_WAIT_AUTHORITY=6, /* 等待权限 | */
   HK_TASK_STATE_ENUM_END=7, /*  | */
} HK_TASK_STATE;
#endif

/** @brief 制导模式 */
#ifndef HAVE_ENUM_HK_GUIDANCE_MODE
#define HAVE_ENUM_HK_GUIDANCE_MODE
typedef enum HK_GUIDANCE_MODE
{
   HK_GUIDANCE_MODE_TRACKING_ONLY=0, /* TRACKING_ONLY | */
   HK_GUIDANCE_MODE_PURE_PURSUIT=1, /* PURE_PURSUIT | */
   HK_GUIDANCE_MODE_PROPORTIONAL_NAVIGATION=2, /* PROPORTIONAL_NAVIGATION | */
   HK_GUIDANCE_MODE_ENUM_END=3, /*  | */
} HK_GUIDANCE_MODE;
#endif

/** @brief 飞行模式，对应 DroneInfo.flight_mode / PX4 uORB VehicleStatus.nav_state；AP 模式由 APMavlinkAdapter 翻译为同一编号 */
#ifndef HAVE_ENUM_HK_FLIGHT_MODE
#define HAVE_ENUM_HK_FLIGHT_MODE
typedef enum HK_FLIGHT_MODE
{
   HK_FLIGHT_MODE_MANUAL=0, /* 手动模式 | */
   HK_FLIGHT_MODE_ALTCTL=1, /* 高度控制模式 | */
   HK_FLIGHT_MODE_POSCTL=2, /* 位置控制模式 | */
   HK_FLIGHT_MODE_AUTO_MISSION=3, /* 自动任务模式 | */
   HK_FLIGHT_MODE_AUTO_LOITER=4, /* 自动悬停/盘旋模式 | */
   HK_FLIGHT_MODE_AUTO_RTL=5, /* 自动返航模式 | */
   HK_FLIGHT_MODE_POSITION_SLOW=6, /* 慢速位置模式 | */
   HK_FLIGHT_MODE_FREE5=7, /* 保留模式 5 | */
   HK_FLIGHT_MODE_FREE4=8, /* 保留模式 4 | */
   HK_FLIGHT_MODE_FREE3=9, /* 保留模式 3 | */
   HK_FLIGHT_MODE_ACRO=10, /* 特技模式 | */
   HK_FLIGHT_MODE_FREE2=11, /* 保留模式 2 | */
   HK_FLIGHT_MODE_DESCEND=12, /* 自动下降模式 | */
   HK_FLIGHT_MODE_TERMINATION=13, /* 紧急终止模式 | */
   HK_FLIGHT_MODE_OFFBOARD=14, /* 外部控制模式 | */
   HK_FLIGHT_MODE_STAB=15, /* 自稳模式 | */
   HK_FLIGHT_MODE_FREE1=16, /* 保留模式 1 | */
   HK_FLIGHT_MODE_AUTO_TAKEOFF=17, /* 自动起飞模式 | */
   HK_FLIGHT_MODE_AUTO_LAND=18, /* 自动降落模式 | */
   HK_FLIGHT_MODE_AUTO_FOLLOW_TARGET=19, /* 自动跟踪目标模式 | */
   HK_FLIGHT_MODE_AUTO_PRECLAND=20, /* 自动精准降落模式 | */
   HK_FLIGHT_MODE_ORBIT=21, /* 环绕模式 | */
   HK_FLIGHT_MODE_AUTO_VTOL_TAKEOFF=22, /* 自动垂直起降转换起飞模式 | */
   HK_FLIGHT_MODE_EXTERNAL1=23, /* 外部自定义模式 1 | */
   HK_FLIGHT_MODE_EXTERNAL2=24, /* 外部自定义模式 2 | */
   HK_FLIGHT_MODE_EXTERNAL3=25, /* 外部自定义模式 3 | */
   HK_FLIGHT_MODE_EXTERNAL4=26, /* 外部自定义模式 4 | */
   HK_FLIGHT_MODE_EXTERNAL5=27, /* 外部自定义模式 5 | */
   HK_FLIGHT_MODE_EXTERNAL6=28, /* 外部自定义模式 6 | */
   HK_FLIGHT_MODE_EXTERNAL7=29, /* 外部自定义模式 7 | */
   HK_FLIGHT_MODE_EXTERNAL8=30, /* 外部自定义模式 8 | */
   HK_FLIGHT_MODE_ENUM_END=31, /*  | */
} HK_FLIGHT_MODE;
#endif

/** @brief VTOL 状态 */
#ifndef HAVE_ENUM_HK_VTOL_STATE
#define HAVE_ENUM_HK_VTOL_STATE
typedef enum HK_VTOL_STATE
{
   HK_VTOL_STATE_UNDEFINED=0, /* 未定义 | */
   HK_VTOL_STATE_TRANSITION_TO_FW=1, /* 转FW中 | */
   HK_VTOL_STATE_TRANSITION_TO_MC=2, /* 转MC中 | */
   HK_VTOL_STATE_MC=3, /* MC | */
   HK_VTOL_STATE_FW=4, /* FW | */
   HK_VTOL_STATE_ENUM_END=5, /*  | */
} HK_VTOL_STATE;
#endif

/** @brief 电机运行状态 */
#ifndef HAVE_ENUM_HK_MOTOR_STATUS_FLAG
#define HAVE_ENUM_HK_MOTOR_STATUS_FLAG
typedef enum HK_MOTOR_STATUS_FLAG
{
   HK_MOTOR_STATUS_NORMAL=0, /* 正常 | */
   HK_MOTOR_STATUS_FAULT=1, /* 故障 | */
   HK_MOTOR_STATUS_FLAG_ENUM_END=2, /*  | */
} HK_MOTOR_STATUS_FLAG;
#endif

/** @brief mavlink_bridge 运行状态 */
#ifndef HAVE_ENUM_HK_BRIDGE_STATUS
#define HAVE_ENUM_HK_BRIDGE_STATUS
typedef enum HK_BRIDGE_STATUS
{
   HK_BRIDGE_STATUS_INITIALIZING=0, /* 初始化中 | */
   HK_BRIDGE_STATUS_NORMAL=1, /* 正常运行 | */
   HK_BRIDGE_STATUS_WARNING=2, /* 告警 | */
   HK_BRIDGE_STATUS_FAULT=3, /* 故障 | */
   HK_BRIDGE_STATUS_ENUM_END=4, /*  | */
} HK_BRIDGE_STATUS;
#endif

/** @brief 发射箱舱盖状态 */
#ifndef HAVE_ENUM_LID_STATUS
#define HAVE_ENUM_LID_STATUS
typedef enum LID_STATUS
{
   LID_CLOSED=0, /* 已关闭 | */
   LID_OPENED=1, /* 已开启 | */
   LID_STATUS_ENUM_END=2, /*  | */
} LID_STATUS;
#endif

/** @brief 发射箱电磁锁扣状态 */
#ifndef HAVE_ENUM_LOCK_STATUS
#define HAVE_ENUM_LOCK_STATUS
typedef enum LOCK_STATUS
{
   LOCK_LOCKED=0, /* 已锁定 | */
   LOCK_RELEASED=1, /* 已解锁 | */
   LOCK_STATUS_ENUM_END=2, /*  | */
} LOCK_STATUS;
#endif

/** @brief 撞击杀伤等级 */
#ifndef HAVE_ENUM_KILL_LEVEL
#define HAVE_ENUM_KILL_LEVEL
typedef enum KILL_LEVEL
{
   KILL_DESTROYED=0, /* 摧毁 | */
   KILL_HEAVY_DAMAGE=1, /* 重创 | */
   KILL_LIGHT_DAMAGE=2, /* 轻伤 | */
   KILL_LEVEL_ENUM_END=3, /*  | */
} KILL_LEVEL;
#endif

/** @brief 跟踪算法 AI 状态文本枚举，对应 recognition_status/status_label */
#ifndef HAVE_ENUM_HK_TRACK_AI_STATUS_LABEL
#define HAVE_ENUM_HK_TRACK_AI_STATUS_LABEL
typedef enum HK_TRACK_AI_STATUS_LABEL
{
   HK_TRACK_AI_STATUS_LABEL_INIT=0, /* 初始化 | */
   HK_TRACK_AI_STATUS_LABEL_DETECTING=1, /* 检测中 | */
   HK_TRACK_AI_STATUS_LABEL_RECOGNIZED=2, /* 已识别 | */
   HK_TRACK_AI_STATUS_LABEL_TRACKING=3, /* 跟踪中 | */
   HK_TRACK_AI_STATUS_LABEL_ENUM_END=4, /*  | */
} HK_TRACK_AI_STATUS_LABEL;
#endif
